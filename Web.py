...
# This is used for the database connectivity check in the health endpoint.
engine = create_engine(DATABASE_URL)

# --- Flask Web Application ---
# Initializes the Flask application. It's named 'run' to match the Gunicorn command `web:run`.
run = Flask(__name__)
...
def home():
    ...
    When accessed, it provides a basic confirmation that the web service is operational.
    """
